...
CamMotion.Engine = function (options) {
  ...
  */
	...
	function draw() {
		canvasSource.getContext("2d").drawImage(videoNode, 0, 0, videoNode.width, videoNode.height);
	}
  ...
  */
	function getAverageMovement(x, y, width, height) {
		...
		var blendedData = contextBlended.getImageData(region.x, region.y, region.width, region.height);
